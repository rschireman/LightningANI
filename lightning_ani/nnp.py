...
def cli_main():
    ...
    # model
    # ------------
    nnp = NNPLightningModel(learning_rate=args.learning_rate, batch_size=args.batch_size, aev_computer=aev_computer, aev_dim=aev_dim, start_force_training_epoch=args.start_force_training_epoch)
